...
do
  ...
  mod.found["gen1_wild_ui"] = { features = { ["gen1party"] = { colours = true } } }
...
do
  ...
  eq(table.concat(installed, ","),
     "autosave,sprint,autocontinue,sound,follower,expshare,caught,banners,"
       .. "interact,npcwalk,modmenu,gen151,menus,remember",
  ...
  eq(table.concat(listed, ","),
     "sprint,interact,npcwalk,banners,follower,remember,expshare,caught,"
...
do
  ...
  local spec = { id = "gen1_wild_qol", menu_label = "GEN1WILD QOL",
                 screen_id = "Gen1WildQOL", paired_bundle = "gen1_wild_ui" }
  local features = {
  ...
  ok(mod.screens["Gen1WildQOL"], "the root screen is registered")
  ok(mod.screens["Gen1WildQOL_returner"], "and one per feature")
