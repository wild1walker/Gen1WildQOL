-- A Pokeball mark on a wild Pokemon already in the Pokedex.
--
...
-- qol_feature_caught_indicator.lua, which is untouched; this file only supplies the
...
return function(mod)
  ...
  local Common = chunk()
  Common.install(mod, "qol_feature_caught_indicator.lua", true)
end
